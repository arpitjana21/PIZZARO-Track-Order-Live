...
var userPassForm = document.querySelector('#user-password');
if (userPassForm) {
...
////////////////////////////////////////////////
////////////////////////////////////////////////
var stripe_publishable_key = "pk_test_51NqsmjSIlszVwdl6FG2Y4B9thApCl8lrWPUXaJ7qIlAwRLR8w3p3pErc7nkBrSpj31tMFgmZcOPfLG0xLAvop4So00JdR1vQHp";
var orderForm = document.querySelector('.order-form');
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(load, orderNow) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          notify("\uD83D\uDD34 ".concat(_context.t0.response.data.message));
        case 13:
        case "end":
...
if (orderForm) {
  ...
  var orderNow = orderForm.querySelector('.order-now');
...
var orderCards = document.querySelectorAll('.orders .card');
if (orderCards) {
  var cardsQty = orderCards.length;
  orderCards.forEach(function (card) {
    var orderID = JSON.parse(card.dataset.order)._id;
...
var subscribeFrom = document.querySelector('.subscribe-form');
if (subscribeFrom) {
  subscribeFrom.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = subscribeFrom.querySelector('input').value;
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/subscribe', {
      email: email
    }).then(function (data) {
      console.log(data);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizzalust_trackpizzalive"] = self["webpackChunkpizzalust_trackpizzalive"] || [];
